# -*- coding: utf-8 -*-
"""Weight Discrepancy.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fleGMMIEXzw2s9qj_4GcGRlhCBq-TCHu
"""
...
# =========================
TOL_DEFAULT = 0.10
DEDUP_CASES_ACROSS_INVOICES = True  # si un CASE/PACKAGE aparece en 2 invoices, tratar como 1 pieza física
...
# =========================
# Regla CAT: tolerancia basada en INVOICE (como tu Excel)
...
# =========================
# ✅ AJUSTE CORRECTO: usa GR como objetivo/límite cuando existe match
# - Si necesitamos BAJAR, una pieza NO baja por debajo de su GR matched (si existe)
# - Si necesitamos SUBIR, una pieza NO sube por encima de su GR matched (si existe)
# - Selecciona pocas piezas, pero si gap es grande permite más (hasta 50% o 20)
# =========================
def gr_guided_adjust_auto(inv_df, gr_map, low, high):
    ...
    def allowed_delta(cur, gr):
        """
        Delta máximo permitido en la dirección requerida.
        GR manda si existe:
          - bajar: hasta GR (delta = cur - gr si gr < cur)
          - subir: hasta GR (delta = gr - cur si gr > cur)
        Si no hay GR, usa ratios anti-locura.
        """
        if cur <= 0:
            return 0.0
    ...
    for _, r in inv.iterrows():
        ...
        # preferencia: si hay GR, mover hacia ese valor tiene prioridad
        preferred = cap  # ya es "hasta GR" si existe, o hasta ratio si no existe

        score = (1000 * min(cap, gap)) + (50 * preferred) + cur
